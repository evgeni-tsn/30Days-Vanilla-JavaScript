...
console.log('Work with Inventors array')
console.log('--------------------------')
...
// Use this on the wikipedia url above
...
console.log('Code for task 6 is commented')
console.log('--------------------------')
console.log('--------------------------')
console.log('Work with People array')
console.log('--------------------------')
console.log(people)
...
console.log('--------------------------')
console.log('--------------------------')
console.log('Work with data array')
console.log('--------------------------')
console.log(data)
